...
def diagnostic_table_week(data):
    ...
    #         ]
    #     },
    #     {'name': 'name-2', 'data': [{'date': 'day1', 'status': 'fail'}, {'date': 'day2', 'status': 'ok'},
    #                                 {'date': 'day3', 'status': 'noexec'}, {'date': 'day4', 'status': 'ok'},
    #                                 {'date': 'day5', 'status': 'noexec'}, {'date': 'day8', 'status': 'ok'},
    #                                 {'date': 'day6', 'status': 'noexec'}, {'date': 'day9', 'status': 'ok'},
    #                                 {'date': 'day7', 'status': 'noexec'}, {'date': 'day90', 'status': 'ok'}
    #                                 ]},
    #     {'name': 'name-3', 'data': [{'date': 'day1', 'status': 'noexec'}, {'date': 'day2', 'status': 'fail'},
    #                                 {'date': 'day3', 'status': 'noexec'}, {'date': 'day4', 'status': 'noexec'},
    #                                 {'date': 'day5', 'status': 'ok'}, {'date': 'day9', 'status': 'noexec'}
    #                                 ]},
    #     {'name': 'name-4', 'data': [{'date': 'day1', 'status': 'ok'}, {'date': 'day2', 'status': 'warning'},
    #                                 {'date': 'day3', 'status': 'fail'}, {'date': 'day4', 'status': 'ok'},
    #                                 {'date': 'day5', 'status': 'ok'}, {'date': 'day7', 'status': 'noexec'}
    #                                 ]},
    #     {'name': 'name-5', 'data': [{'date': 'day1', 'status': 'warning'}, {'date': 'day2', 'status': 'ok'},
    #                                 {'date': 'day3', 'status': 'ok'}, {'date': 'day4', 'status': 'ok'}
    #                                 ]},
    #     {'name': 'name-6',
    #      'data': [{'date': 'day1', 'status': 'ok'}, {'date': 'day2', 'status': 'ok'}, {'date': 'day3', 'status': 'ok'},
    #               {'date': 'day4', 'status': 'warning'}]}
    # ]
